...
- Embed videos (Issue [#19](https://github.com/timhutton/twitter-archive-parser/issues/19)) as HTML snippets in the markdown (currently just the thumbnail is shown).
